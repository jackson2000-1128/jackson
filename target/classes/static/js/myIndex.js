$(function(){
    ...
    function menuItem(){
		...
		// 选项卡菜单不存在
 		if(flag){
            ...
            // 添加选项卡对应的iframe
            var str1 = '<iframe  onload="this.height=this.contentWindow.document.documentElement.scrollHeight" class="RuoYi_iframe" name="iframe' + dataIndex + '" width="100%"  src="' + dataUrl + '" frameborder="0" data-id="' + dataUrl + '" seamless ></iframe>';
    ...
    function closeTab() {
        ...
        console.log(closeTabId,currentWidth);
        // 当前元素处于活动状态
